package com.example.bangkit_2024_made.ReactiveProgramming.ReactiveX
...
import com.example.bangkit_2024_made.databinding.ActivityMainReactiveXBinding
import com.jakewharton.rxbinding2.widget.RxTextView
import io.reactivex.Observable
import io.reactivex.functions.Function3

class MainActivityReactiveX : AppCompatActivity() {
    private lateinit var binding: ActivityMainReactiveXBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMainReactiveXBinding.inflate(layoutInflater)
        ...
        // merge hanya menggabungkan datanya saja
        ...
        // Membaca ketiga data stream tersebut untuk menentukan apakah tombol diaktifkan atau tidak
        // combineLatest yaitu menggabungkan dan mengubah data di dalamnya
